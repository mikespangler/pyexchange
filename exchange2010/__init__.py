...
class Exchange2010RoomService(object):
  ...
  def get_availability(self, roomList_email):
    return Exchange2010RoomAvailability(service=self.service, room_email=roomList_email)
...
class Exchange2010RoomAvailability(object):
